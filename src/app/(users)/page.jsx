...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#F9F6E6] pt-24">
      ...
      {/* Founder Section */}
      <section className="flex flex-col items-center justify-center min-h-[70vh] px-4 sm:px-6 lg:px-32 py-12 ">
        <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl gap-8 bg-[#578E7E] rounded-xl p-6 sm:p-8">
          <div className="w-full lg:w-1/2 flex justify-center">
            <Image
              src="/founder.jpg"
              alt="Founder"
              width={350}
              height={350}
              className="rounded-xl w-full max-w-[350px] h-auto object-cover"
              draggable={false}
            />
          </div>
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-white text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base lg:text-lg font-poppins">
              Our founder, [Founder’s Name], envisioned a sanctuary where orphans and the elderly could find solace.
            </p>
            <p className="text-sm sm:text-base lg:text-lg font-poppins">
            ...
            <Link
              href="/contact"
              className="px-5 py-3  text-[#578E7E] font-medium font-outfit text-lg rounded-xl hover:bg-gray-100 transition duration-300 w-fit mx-auto lg:mx-0"
            >
              Contact
            </Link>
          </div>
      ...
      <section className="flex flex-col items-center justify-center min-h-[70vh] px-4 sm:px-6 lg:px-32 py-12">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-6xl gap-8">
          <div className="w-full lg:w-1/2 flex flex-col gap-6 text-center lg:text-left">
            ...
            <Link
              href="/about"
              className="px-6 py-3 bg-[#578E7E] text-white font-medium font-outfit text-lg rounded-xl hover:bg-[#466f65] transition duration-300 w-fit mx-auto lg:mx-0"
            >
              Learn More
            </Link>
          </div>
      ...
      {/* Facilities Section */}
      <section className="flex flex-col items-center justify-center min-h-[70vh] px-4 sm:px-6 lg:px-32 py-12 ">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-outfit font-semibold text-[#578E7E] mb-10 text-center">
          ...
          {[
            ...
            >
              <Image
                ...
                draggable={false}
              />
              <p className="italic text-sm sm:text-base font-poppins text-center mb-3 flex-grow">
                "{testimonial.quote}"
              </p>
